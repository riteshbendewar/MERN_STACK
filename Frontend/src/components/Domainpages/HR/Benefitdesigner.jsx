    ...
    <div className="max-w-6xl mx-auto p-5">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
                  Our HR program is designed to help you grow as an HR Specialist. Here are some of the benefits you'll get from completing the program.
                </p>
              </div>
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Learn from experienced HR Specialists</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Our instructors are experienced HR Specialists from top companies</p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Master HR Management skills</h2>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">Get Job Opportunities like HR Manager, HR Specialist, Recruitment Consultant, Talent Acquisition Manager, HR Business Partner, Employee Relations Manager, Compensation and Benefits Analyst, Training and Development Manager, HR Generalist.</p>
                  </div>
