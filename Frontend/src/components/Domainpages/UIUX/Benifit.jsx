...
const Benifit = () => {
  ...
  return (
    <div>
      <div className="flex  max-w-4xl  mx-auto flex-col gap-10 px-4 py-10  ">
                <div className="flex flex-col gap-4">
                  ...
                  Our program is designed to help you grow as a designer. Here are some of the benefits you'll get from completing the program.
                  </p>
                </div>
                <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                  ...
                  <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Our instructors are experienced designers from top companies
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Get Job Opportunities like UI/UX Designer, User Experience Researcher, User Interface Designer, Interaction Designer, Product Designer, UX Analyst, UX/UI Developer, Visual Designer, UX Strategist, Design Consultant.
                      </p>
                    </div>
                  </div>
                ...
                <div>
              <h2 className="text-[#0d151c] text-center text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
