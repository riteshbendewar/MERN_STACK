  ...
  return (
    <div>
      <div className="flex justify-center    flex-col items-center">
        <div className="con220  md:max-w-6xl md:w-[60%] w-[92%] h-54  mx-auto   mt-6 md:mt-10 ">
          <div className=" con22 flex space-y-4  md:space-y-8 p-8 rounded-xl flex-col h-full justify-end   ">
            ...
            <h2 className="text-white md:text-lg text-md font-normal ">
              Our live, online UI/UX design workshop helps you build the skills
        ...
        <div className=" w-full md:w-[60%]  max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-10 px-4 py-10 @container ">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
                ...
                aspect of UI/UX design. You'll <br />
                learn by doing - we'll give you real-world projects to help you
                practice what you learn. Here's
                <br /> the breakdown:
              </p>
            </div>
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0  ">
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="text-[#0d151c] text-base font-bold leading-tight">
                    Week 1: Understand UI/UX
                  </h2>
                  <p className="text-[#49779c] text-sm font-normal leading-normal">
                    Learn the fundamentals of UI/UX design, user research, and
                    design thinking. Understand the role of a designer in a
                    digital environment.
                  </p>
                </div>
              </div>
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                ...
                <div className="flex flex-col gap-1 ">
                  ...
                  <p className="text-[#49779c] text-sm font-normal leading-normal">
                    Develop the skills to create intuitive, user-friendly
                    designs based on principles like hierarchy, consistency, and
                    feedback. Learn the importance of user experience in design.
                  </p>
                </div>
              </div>
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#49779c] text-sm font-normal leading-normal">
                    ...
                    including Adobe XD, Figma, and Sketch. Understand the role
                    of a designer in a collaborative environment.
                  </p>
                </div>
              </div>
              <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#919ea8] text-sm font-normal leading-normal">
                    Learn how to apply your design skills to real-world
                    projects, including web and mobile interfaces. Understand
                    the role of a designer in the development process.
                  </p>
                </div>
              </div>
            </div>
