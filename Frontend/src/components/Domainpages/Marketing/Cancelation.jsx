...
function Benefitmarketing() {
  return (
    <div class="flex flex-col gap-10 lg:px-48 py-10 sm: px-10  ">
      <div class="flex flex-col gap-4 ">
          ...
          <p class="text-[#0d151c] text-base font-normal leading-normal max-w-[720px]">
            {" "}
            Our Marketing program is designed to help you grow as a Marketer. Here are some of the benefits you'll get from completing the program.
          </p>
      ...
      <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
        ...
        <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
          ...
          <div class="flex flex-col gap-1">
            ...
            <p class="text-[#49779c] text-sm font-normal leading-normal">
            Our instructors are experienced Marketers from top companies
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
          ...
          <div class="flex flex-col gap-1">
            ...
            <p class="text-[#49779c] text-sm font-normal leading-normal">
            Marketing Coordinator, Marketing Manager, Digital Marketing Specialist, Social Media Manager, Brand Manager, Content Marketer, SEO Specialist, Marketing Analyst, Product Manager, Advertising Manager, Public Relations Specialist, Market Research Analyst.
            </p>
          </div>
        </div>
      </div>
...
export default Benefitmarketing