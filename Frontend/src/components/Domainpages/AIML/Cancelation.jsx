...
function Benefitsaiml() {
  return (
    <div class="flex flex-col gap-10 lg:px-48 py-0 sm: px-10 py-0 ">
    ...
    <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
      ...
      <div class="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col">
        ...
        <div class="flex flex-col gap-1">
          ...
          <p class="text-[#49779c] text-sm font-normal leading-normal">
          Get job opportunities such as Data Scientist, Machine Learning Engineer, AI Research Scientist, Data Analyst, Business Intelligence (BI) Developer, AI Product Manager, Natural Language Processing (NLP) Engineer, Computer Vision Engineer, Robotics Engineer, AI Consultant, Big Data Engineer, Quantitative Analyst.
          </p>
        </div>
      </div>
    </div>
